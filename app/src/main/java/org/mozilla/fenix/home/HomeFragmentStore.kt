 ...
 * @property historyMetadata The list of [HistoryMetadataContainer].
 */
data class HomeFragmentState(
    ...
    val historyMetadata: List<HistoryMetadataContainer> = emptyList()
) : State
...
sealed class HomeFragmentAction : Action {
    data class Change(
        ...
        val historyMetadata: List<HistoryMetadataContainer>
    ) :
        HomeFragmentAction()
    ...
    data class HistoryMetadataChange(val historyMetadata: List<HistoryMetadataContainer>) : HomeFragmentAction()
    data class HistoryMetadataExpanded(val historyMetadataContainer: HistoryMetadataContainer) : HomeFragmentAction()
        ...
        is HomeFragmentAction.HistoryMetadataExpanded -> {
            state.copy(
                historyMetadata = state.historyMetadata.toMutableList()
                    .map {
                        if (it == action.historyMetadataContainer) {
