...
class SessionControlInteractor(
    ...
    override fun onToggleHistoryMetadataContainerExpanded(historyMetadataContainer: HistoryMetadataContainer) {
        historyMetadataController.handleToggleHistoryMetadataContainerExpanded(
